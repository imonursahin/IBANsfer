...
class IbanScannerHomeScreen extends StatefulWidget {
  @override
  _IbanScannerHomeScreenState createState() => _IbanScannerHomeScreenState();
}

class _IbanScannerHomeScreenState extends State<IbanScannerHomeScreen> {
